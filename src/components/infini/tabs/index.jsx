...
export default class Tabs extends React.Component {
  ...
  renderTabs = ({ getPrefixCls }) => {
    ...
    const newTabBarExtraContent = tabBarExtraContent ? (
      <>
        <div className={`${prefixCls}-extra-content ant-tabs-extra-append`}>
          {tabBarExtraContent?.append}
        </div>
        <div
          className={`${prefixCls}-extra-content ant-tabs-extra-left`}
        ...
        <div
          ...
          className={`${prefixCls}-extra-content ant-tabs-extra-right`}
        >
      ...
      <RcTabs
        ...
        renderTabBar={() => (
          <TabBar
            ...
            tabBarExtraContent={newTabBarExtraContent}
          />
        )}
        renderTabContent={() => (
          <TabContent
  ...
  render() {
    return (
      <div className="flex-tabbar">
        <ConfigConsumer>{this.renderTabs}</ConfigConsumer>
      </div>
    );
  }
}
