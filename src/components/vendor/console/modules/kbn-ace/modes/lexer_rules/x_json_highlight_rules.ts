...
import { ElasticsearchSqlHighlightRules } from './elasticsearch_sql_highlight_rules.ts';
import { ScriptHighlightRules } from './script_highlight_rules.ts';
...
export function XJsonHighlightRules(this: any) {
  let startRules = jsonRules('start') as any[];
  this.$rules = {
    ...startRules,
  };
